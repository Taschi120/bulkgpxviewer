...
class Application private constructor() {
    ...
    init {
        ...
        Application.log.info("Guice dependency injector created")
    }

    private fun start() {
        Application.log.info("Application startup") //$NON-NLS-1$
        try {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName())
        } catch (e: Exception) {
            Application.log.error("Error while setting system look and feel", e) //$NON-NLS-1$
        }
