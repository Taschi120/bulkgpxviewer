...
class DurationCalculator constructor() {
    ...
    fun getSegmentDuration(segment: TrackSegment): Optional<Duration?> {
        ...
        if (waypoints.size < 2) {
            DurationCalculator.log.debug("Time calculation impossible: List has fewer than 2 waypoints") //$NON-NLS-1$
        ...
        if (start == null || end == null) {
            DurationCalculator.log.debug("Time calculation impossible: GPX does not contain timestamps") //$NON-NLS-1$
