...
class AvgSpeedNode(parent: GpxFileTreeNode?) : DefaultMutableTreeNode(), GpxFileRelatedNode {
    ...
    protected val parent: GpxFileTreeNode
    ...
    private fun getLabel(file: GpxFile): String {
        val unitSystem = settingsManager.getSettings().unitSystem
        val formattedSpeed = speedCalculator!!.getFormattedAverageSpeed(parent.getTrack().getGpx(), unitSystem)
