...
class Settings constructor() {
    private val lastUsedDirectory: String? = null
    private val routeColors: List<SettingsColor>? = null
    private val mainWindowSettings: MainWindowSettings? = null
    private val unitSystem: UnitSystem? = null
    private val unselectedRouteColor: SettingsColor? = null
    private val selectedRouteColor: SettingsColor? = null
}