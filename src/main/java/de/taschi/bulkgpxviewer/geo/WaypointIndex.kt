...
@Data
@Builder
class WaypointIndex constructor() : Comparable<WaypointIndex?> {
    private val gpx: GPX? = null
    private val trackId: Int = 0
    private val segmentId: Int = 0
    private val waypointId: Int = 0
    ...
    fun isOnSameSegment(other: WaypointIndex): Boolean {
        return (other.getGpx() === this.gpx
                ) && (other.getTrackId() == trackId
                ) && (other.getSegmentId() == segmentId)
    }
}